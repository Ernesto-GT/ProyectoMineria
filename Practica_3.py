...
def EstadisticaPorGeneroYPuntajes():
    ...
    #print(resultado)
    resultado.to_csv('Tablas_P3/DataSet_Genero-Puntajes.csv')
...
def EstadisticaPorGeneroYSeguidores():
    ...
    #print(resultado)
    resultado.to_csv('Tablas_P3/DataSet_Genero-Seguidores.csv')
...
def EstadisticaPorTipoYPuntajes():
    ...
    resultado.columns = ['Total_Animes', 'Promedio', 'Puntaje_Minimo', 'Puntaje_Maximo', 'Desviacion_Estandar', 'Varianza']
    #print(resultado)
    resultado.to_csv('Tablas_P3/DataSet_Tipo-Puntajes.csv')
...
def EstadisticaPorFechaYPuntajes():
    ...
    resultado.columns = ['Total_Animes', 'Promedio', 'Puntaje_Minimo', 'Puntaje_Maximo', 'Desviacion_Estandar', 'Varianza']
    #print(resultado)
    resultado.to_csv('Tablas_P3/DataSet_Fecha-Puntajes.csv')
...
def EstadisticaPorGeneroYEpisodios():
    ...
    resultado.columns = ['Total_Animes', 'Promedio', 'Puntaje_Minimo', 'Puntaje_Maximo', 'Desviacion_Estandar', 'Varianza']
    #print(resultado)
    resultado.to_csv('Tablas_P3/DataSet_Genero-Episodios.csv')
