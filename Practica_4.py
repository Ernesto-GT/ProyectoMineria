...
plt.suptitle("Promedio de Puntaje Agrupados por Genero (Top-100)", fontweight="bold")
...
plt.suptitle("Promedio de Puntaje Agrupados por Tipo de Visualizacion (Top-100)", fontweight="bold")
...
plt.suptitle("Cantidad de Series Registradas Agrupadas por Genero (Top-100)", fontweight="bold")
plt.axis('equal')
...
plot = df_v.plot.pie(y='Type', figsize=(10,10), autopct="%1.0f%%", startangle=100, explode=desfase)
plt.suptitle("Cantidad de Series Registradas Agrupadas por Tipo de Visualizacion (Top-100)", fontweight="bold")
plt.axis('equal')
